...
[![Kotlin version](https://img.shields.io/badge/kotlin-2.3.10-red?logo=kotlin)](http://kotlinlang.org)
...
- **Multi-provider support**: 16 model providers (OpenAI, Anthropic, Google, Groq, etc.), 18 voice providers (ElevenLabs,

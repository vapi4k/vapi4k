...
enum class CartesiaVoiceLanguageType(
  ...
  fun isSpecified() = this != com.vapi4k.api.voice.enums.CartesiaVoiceLanguageType.UNSPECIFIED

  fun isNotSpecified() = this == com.vapi4k.api.voice.enums.CartesiaVoiceLanguageType.UNSPECIFIED
}

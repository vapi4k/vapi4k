...
import com.vapi4k.dsl.model.InflectionAIModelProperties
...
@Serializable
data class InflectionAIModelDto(
  var model: String = "",
  @Transient
  override var modelType: InflectionAIModelType = InflectionAIModelType.UNSPECIFIED,
  @Transient
  ...
  fun verifyValues() {
    if (modelType.isSpecified() && customModel.isNotEmpty())
      error("inflectionAIModel{} cannot have both modelType and customModel values")

    if (modelType.isNotSpecified() && customModel.isEmpty())
      error("inflectionAIModel{} must have either a modelType or customModel value")
  }
}

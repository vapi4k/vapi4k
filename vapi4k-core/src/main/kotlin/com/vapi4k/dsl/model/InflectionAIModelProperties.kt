...
interface InflectionAIModelProperties {
  /**
  This is the name of the model.
   */
  var modelType: InflectionAIModelType

  /**
  This enables specifying a model that doesn't already exist as an InflectionAIModelType enum.
   */
